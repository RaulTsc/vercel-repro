...
export const EDIT_COMPANY_FORM_DIALOG = "EDIT_COMPANY_FORM_DIALOG";

type PropsFromRedux = ConnectedProps<typeof connector>;
export type EditCompanyFormDialogProps = PropsFromRedux &
  FormProps<ICompany> & {
    loading: boolean;
  };
export const _EditCompanyFormDialog = (props: EditCompanyFormDialogProps) => {
  const intl = useIntl();
  ...
  return (
    <FormDialog<ICompany>
      ...
      title={
        <FormattedMessage id="App.common.company.editCompanyInformation" />
      }
...
export const EditCompanyFormDialog = connector(_EditCompanyFormDialog);
